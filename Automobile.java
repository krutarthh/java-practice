 ...
 * automobile has a certain fuel efficiency (measured in km/liters) and a
 * certain
 * amount of fuel in the gas tank. The efficiency is initialized in the
 * constructor method via the parameter, and the initial fuel level is 0. Supply
 ...
 * Look at the tester code (AutomobileTester.java) for help in understanding
 * these methods
 * 
 * Difficulty: Easy
 */
