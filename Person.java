...
public class Person {
    ...
    public void befriend(Person p) {
        ...
        // add (concatenate) the first name of Person p to the String friendList
        // followed by a space " "
    ...
    public void unfriend(Person p) {
        // -----------Start below here. To do: approximate lines of code = 2
        // removes the first name of Person p from the friendList string. Decrement
        // friendCount
        // Hint: use the replace method of class String. Don't forget to remove the
        // space following the first name (see befriend above)
